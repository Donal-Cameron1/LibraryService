...
namespace LibraryService.DAL
{
    public class LibraryInitialiser : DropCreateDatabaseAlways<LibraryContext>
    {
        protected override void Seed(LibraryContext context)
        {
            ...
            {
                new Library {Address="London Road", Housenumber="12", PostCode="S2 4NF", Name="Highfield Library", Capacity=12345, TelephoneNumber="0114 1234567", OpeningHours="Monday - Friday 8am-9pm", Coord="53.366833, -1.474933"}, 
